goog.provide('hexgrid.render.renderengine');

goog.require('glmatrix');
goog.require('hexgrid.render.camera');
goog.require('hexgrid.render.shaders');
...
function HexRenderEngine(canvas) {
	...
	function initShaders() {
		var fragmentShader = getShader(basic_fs, SHADER_TYPE_FRAG);
		var vertexShader = getShader(basic_vs, SHADER_TYPE_VERT);
        ...
        var fs = getShader(texture_fs, SHADER_TYPE_FRAG);
        var vs = getShader(texture_vs, SHADER_TYPE_VERT);
