define(['hex','ai','util','render/renderengine'],function(Hex, AI, Util, RenderEngine){
	...
	function HexGrid(canvas) {
		...
		this.getLine = function(hex1, hex2){
			...
			for (var i = 0; i < distance; i++) {
				...
				var nextY = hex1.y + dY;
				var nextZ = hex1.z + dZ;
				var blah = Util.convertXYZtoQR(nextX, nextY, nextZ);
		...
		var pathFinder = new AI.astar(this, function(){return 1;});
